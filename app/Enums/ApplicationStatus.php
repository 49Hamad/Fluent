...
enum ApplicationStatus: string implements HasLabel, HasColor
{
    ...
    public function studentMessage(): string
    {
        return match ($this) {
            ...
            self::PreliminaryAccepted => 'يسعدنا إبلاغك بقبولك مبدئيًا في تجربة Fluent. لتأكيد مقعدك أكمل الخطوات في «مساحتي في Fluent»: الموافقة على اتفاقية المشاركة، ثم التحويل البنكي ورفع الإيصال. يتأكد مقعدك بعد تحققنا من السداد.',
