...
<div class="relative filament-apex-charts-filter-form">
    <div class="flex items-center justify-center cursor-pointer filament-dropdown-trigger" aria-expanded="false">
        <button type="button" @click="dropdownOpen = !dropdownOpen"
            class="relative flex items-center justify-center text-gray-400 transition duration-75 rounded-lg outline-none fi-icon-btn focus:ring-2 disabled:pointer-events-none disabled:opacity-70 h-9 w-9 hover:text-gray-500 focus:ring-primary-600 dark:text-gray-500 dark:hover:text-gray-400 dark:focus:ring-primary-500 fi-ac-icon-btn-action"
            title="Filter">
            ...
            <x-filament::icon icon="heroicon-s-funnel" class="w-5 h-5" />

            @if ($indicatorsCount > 0)
                <div class="absolute top-0 z-10 -translate-x-1/2 bg-white rounded-md start-full -ms-1 dark:bg-gray-900">
    ...
    <div x-show="dropdownOpen" x-cloak @class([
        ...
        <div class="px-6 py-4">
            ...
            <div class="flex justify-end gap-6 mt-2 text-end">
